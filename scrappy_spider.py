...
class SpiderCrawler(scrapy.Spider):
    ...
    start_urls = ["https://www.fatsecret.co.in/calories-nutrition/search?q=biscuits&pg=0"]
...
#     name = "sweets"
#     allowed_domains = ["fatsecret.co.in"]
#     start_urls = ["https://www.fatsecret.co.in/calories-nutrition/search?q=egg&pg=0"]
...
#     def parse_nutrition(self, response):
#         sweet_name = response.meta['sweet_name']
#         # Find and click the '100 g' link
#         link_100g = response.xpath("//a[contains(text(), '100 g')]/@href").get()
#         if link_100g:
#             yield response.follow(link_100g, self.parse_100g, meta={'sweet_name': sweet_name})

#     def parse_100g(self, response):
#         sweet_name = response.meta['sweet_name']
#         # Extract factTitle and factValue
#         facts = {}
#         for row in response.css('td.fact'):
...
#     name = "sweets"
#     allowed_domains = ["fatsecret.co.in"]
#     start_urls = ["https://www.fatsecret.co.in/calories-nutrition/search?q=sweets&pg=5"]
